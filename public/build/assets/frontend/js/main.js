(function ($) {
  ...
  var imJs = {
      ...
      swiperActivation: function (){
        ...
        $(document).ready(function() {
            document.querySelectorAll('.pricingSlider-Desktop').forEach((slider, index) => {
  new Swiper(slider, {
    slidesPerView: 1,
    spaceBetween: 24,
    speed: 1800,
    ...
    // },
    pagination: {
      el: `.swiper-pagination${index}`, // unique class per slider
      clickable: true,
    },
    breakpoints: {
      992: { slidesPerView: 1 },
      ...
      0:   { slidesPerView: 1 },
        ...
        //   var swiper = new Swiper(".pricingSlider-Desktop", {
        //     slidesPerView: 1,
        //     spaceBetween: 24,
        //     speed: 1800,
        //     loop: true,
        ...
        $(document).ready(function() {
          var swiper = new Swiper(".pricingSlider-Mobile", {
            slidesPerView: 1,
            spaceBetween: 24,
            speed: 1800,
            loop: true,
...
document.addEventListener("DOMContentLoaded", () => {
  const tabCustomButtons = document.querySelectorAll(".custom-tab-btn");
  const tabCustomContents = document.querySelectorAll(".custom-tab-content");
  tabCustomButtons.forEach(button => {
    button.addEventListener("click", () => {
      tabCustomButtons.forEach(btn => btn.classList.remove("active"));
      tabCustomContents.forEach(content => content.classList.remove("active"));
...
document.addEventListener("DOMContentLoaded",function(){
    const tabButtons = document.querySelectorAll('.tab-pricing-btn');
...
document.addEventListener("DOMContentLoaded", function () {
    const tabCustomButtons = document.querySelectorAll('.custom-tab-mb-btn');
    const tabCustomContents = document.querySelectorAll('.content-tab-mb-btn');
    ...
    tabCustomButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            if (activeContent) {
                ...
                console.warn(`No content found with ID: ${targetTab}`);
            }
        });
    });
});
