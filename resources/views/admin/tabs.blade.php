                ...
                <div class="card-body">
                    <form wire:submit="{{ $form_url }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-lg-6">
                                <label for="exampleFormControlInput1" class="form-label">Priority <span
                                        class="text-danger">*</span></label>
                                        <input type="number" class="form-control shadow-none" id="priority" 
                                        placeholder="Enter Priority" wire:model="priority">
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            Swal.fire(
                                'Deleted!', 'Tab has been deleted.', 'success'
                            );
                            setTimeout(() => {
                        ...
                        error: function(xhr, status, error) {
                            Swal.fire(
                                'Error!', 'An error occurred while deleting the tab.',
                                'error'
                            );
                        }
                    });
