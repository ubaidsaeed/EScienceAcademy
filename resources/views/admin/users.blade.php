                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input type="email" class="form-control shadow-none" id="email"
                                    placeholder="Enter Email" wire:model="email" autocomplete="email">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                @error('password') <span class="error" style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3 col-lg-6">
                                <div x-data x-init="$nextTick(() => {
                                    ...
                                    <label for="exampleFormControlInput1" class="form-label">Role Assign</label>
                                    <select class="form-control select2-show-search custom-select" x-ref="role"
