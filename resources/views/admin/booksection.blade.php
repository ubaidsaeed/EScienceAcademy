            ...
            <div class="side-app main-container"> --}}
                ...
                <div class="page-header d-lg-flex d-block">
                    <div class="page-leftheader">
                        <div class="page-title">Book Section</div>
                    </div>
                </div>
                <!--End Page header-->
                                ...
                                <div class="card item-card overflow-hidden">
                                    <div class="item-image">
                                        ...
                                        <div class="product-overly">
                                            <a href="{{route('admin.student.book.detail.section')}}" class="text-white"><i class="fa fa-eye me-1"></i><span>View</span></a>
                                        </div>
                                    </div>
                                    <div class="card-body text-center">
                                        <a class="shop-title">MCQS</a>
