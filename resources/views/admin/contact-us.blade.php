<div class="">
    ...
    <div class="page-header d-lg-flex d-block">
        ...
        <div class="page-leftheader">
            <h4 class="page-title">Contact's</h4>
        </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-lg-6">
                             ...
                             <div class="mb-3 col-lg-6">
                                ...
                                <input type="text" class="form-control shadow-none" id="name" placeholder="Enter "
                                    wire:model="email">
                                <input type="hidden" wire:model="id">
                            ...
                            <div class="mb-3 col-lg-12">
                               ...
                               <textarea class="form-control" id="myeditorinstances" x-ref="myeditorinstances" rows="3" wire:model="message"></textarea>
                            </div>
