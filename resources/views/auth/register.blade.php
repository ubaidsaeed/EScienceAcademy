        ...
        <style>
         ...
         @php $sugment =request()->segment(2); @endphp
            ...
            <div class="login-container">
                ...
                @csrf
                <input type="text" placeholder="Name" value="{{old('name')}}" required class=" login-option" name="name">
                @error('name')
                ...
                <div class="text-danger mt-2">{{ $message }}</div>
                @enderror
                <input type="hidden" name="pack" value="{{$sugment}}">
                <button class="btn btn-success login-button md-sm-2" type="submit">
                    Sign up
                </button>
            </form>
                <p class="signup-text">
                    Already registered? <a href="{{route('subscription.package',$sugment)}}">Log in</a>
                </p>
