<div class=" app-header header sticky" style="position:unset !important">
    <div class="container-fluid main-container">
        <div class="d-flex">
            <a class="header-brand" href="#">
                ...
                <!--    alt="EscienceAcademy">-->
                <!--<img src="{{asset('build/assets/admin/images/brand/logo-white.png')}}"-->
                <!--    class="header-brand-img dark-logo" alt="EscienceAcademy">-->
                ...
                <!--    class="header-brand-img darkmobile-logo" alt="EscienceAcademy">-->
            </a>
            ...
            <div class="d-flex order-lg-2 my-auto ms-auto">
                ...
                <div class="mb-0 navbar navbar-expand-lg navbar-nav-right responsive-navbar navbar-dark p-0">
                    <div class="collapse navbar-collapse" id="navbarSupportedContent-4" style="visibility:unset !important">
                        <div class="d-flex ms-auto">
                            ...
                            <!--                            data-bs-image-src="{{asset('build/assets/admin/images/users/1.jpg')}}"></span>-->
                            <!--                    </div>-->
                            <!--                    <div class="d-flex">-->
                            ...
                            <!--                    <div class="">-->
                            <!--                        <span class="avatar avatar-md brround align-self-center cover-image"-->
                            <!--                            data-bs-image-src="{{asset('build/assets/admin/images/users/2.jpg')}}"></span>-->
                            <!--                    </div>-->
                            <!--                    <div class="d-flex">-->
                            <!--                        <div class="ps-3 text-wrap text-break">-->
                            ...
                            <!--                    <div class="">-->
                            <!--                        <span class="avatar avatar-md brround align-self-center cover-image"-->
                            <!--                            data-bs-image-src="{{asset('build/assets/admin/images/users/3.jpg')}}"></span>-->
                            <!--                    </div>-->
                            <!--                    <div class="d-flex">-->
                            <!--                        <div class="ps-3 text-wrap text-break">-->
                            ...
                            <!--                    <div class="">-->
                            <!--                        <span class="avatar avatar-md brround align-self-center cover-image"-->
                            <!--                            data-bs-image-src="{{asset('build/assets/admin/images/users/4.jpg')}}"></span>-->
                            <!--                    </div>-->
                            <!--                    <div class="d-flex">-->
                            <!--                        <div class="ps-3 text-wrap text-break">-->
                            ...
                            <!--                    <div class="">-->
                            <!--                        <span class="avatar avatar-md brround align-self-center cover-image"-->
                            <!--                            data-bs-image-src="{{asset('build/assets/admin/images/users/6.jpg')}}"></span>-->
                            <!--                    </div>-->
                            <!--                    <div class="d-flex">-->
                            <!--                        <div class="ps-3 text-wrap text-break">-->
                            ...
                            <div class="dropdown profile-dropdown">
                                <a href="javascript:void(0);" class="nav-link pe-1 ps-0 leading-none"
                                    ...
                                    <span>
                                        <img src="{{asset('build/assets/admin/images/users/16.jpg')}}" alt="img"
                                            class="avatar avatar-md bradius">
                                    </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                                    <div class="p-3 text-center border-bottom">
                                        <a href="javascript:void(0)" class="text-center user pb-0 font-weight-bold">
                                            {{Illuminate\Support\Facades\Auth::user()->name}}</a>
                                        <p class="text-center user-semi-title" style="font-size:10px !important">{{Illuminate\Support\Facades\Auth::user()->email}}</p>
                                    </div>
                                    ...
                                    <a class="dropdown-item d-flex" href="javascript:void(0);" data-bs-toggle="modal"
